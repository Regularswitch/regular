...
add_action('admin_enqueue_scripts', function (string $hook): void {
    ...
    wp_enqueue_style('rs-admin-chrome', $base . 'assets/rs-admin-chrome.css', ['rs-design-system'], $ver);
    wp_enqueue_script('rs-admin-chrome', $base . 'assets/rs-admin-chrome.js', ['jquery'], $ver, true);

    wp_enqueue_style('rs-metabox-ui', $base . 'assets/rs-metabox-ui.css', ['rs-design-system', 'rs-admin-chrome'], $ver);
