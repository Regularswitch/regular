...
export default function LegalWpPage({ title, content }: LegalWpPageProps) {
	return (
		<article className="legal-page mx-auto max-w-3xl px-7 py-10 md:py-14">
			{title ? (
				<h1 className="mb-8 font-hk text-[clamp(1.75rem,4vw,2.5rem)] font-extrabold leading-tight tracking-[-0.02em]">
					{title}
				</h1>
			) : null}
			<div
